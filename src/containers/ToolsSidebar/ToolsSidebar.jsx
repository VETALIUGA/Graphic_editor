...
const ToolsSidebar = ({ title, disabled }) => {
    return (
        <section className="section tools-sidebar__section">
            ...
            <NavLink className={`tools-sidebar__link link text--xsm ${disabled ? 'disabled' : ''}`} activeClassName="tools-sidebar__link--active" to='/recovery'>
                <FontAwesomeIcon icon={faToolbox} className="tools-sidebar__icon icon--md" />
                <span className="tools-sidebar__title">Відновлення</span>
            </NavLink>
            <NavLink className={`tools-sidebar__link link text--xsm ${disabled ? 'disabled' : ''}`} activeClassName="tools-sidebar__link--active" to='/color'>
            ...
            <NavLink className={`tools-sidebar__link link text--xsm ${disabled ? 'disabled' : ''}`} activeClassName="tools-sidebar__link--active" to='/crop'>
                <FontAwesomeIcon icon={faCropAlt} className="tools-sidebar__icon icon--md" />
                <span className="tools-sidebar__title">Обрізання</span>
            </NavLink>
            <NavLink className={`tools-sidebar__link link text--xsm ${disabled ? 'disabled' : ''}`} activeClassName="tools-sidebar__link--active" to='/compress'>
